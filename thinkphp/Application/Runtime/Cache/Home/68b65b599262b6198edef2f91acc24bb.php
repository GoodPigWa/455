...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/thinkphp/Public/Home/css/jsstyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="/thinkphp/Public/Home/js/address.js"></script>
			...
			<div class="concent">
				...
				<div class="paycont">
							...
							<?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["default"] == '1'): ?><li class="user-addresslist defaultAddr">
										<div class="address-left">
											<div class="user DefaultAddr">
												...
												<input type="text" class="add_id" value="<?php echo ($vo["add_id"]); ?>">
 
		                   						<span class="buy-user"><?php echo ($vo["name"]); ?> </span>
												<span class="buy-phone"><?php echo ($vo["tele"]); ?></span>
												</span>
											</div>
										   ...
										   <span class="province"><?php echo ($vo["province"]); ?></span>省
												...
												<span class="street"><?php echo ($vo["street"]); ?></span>
												</span>
					...
					<div class="logistics">
						<h3>选择支付方式</h3>
						<ul class="pay-list">
							<li class="pay card"><img src="/thinkphp/Public/Home/images/wangyin.jpg" />银联<span></span></li>
							<li class="pay qq"><img src="/thinkphp/Public/Home/images/weizhifu.jpg" />微信<span></span></li>
							<li class="pay taobao"><img src="/thinkphp/Public/Home/images/zhifubao.jpg" />支付宝<span></span></li>
						</ul>
					</div>
					<div class="clear"></div>
					...
					<div class="concent">
						<div id="payTable">
							...
							<div class="clear"></div>
							<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="item-list">
								<div class="bundle  bundle-last">
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="/thinkphp/Public/Home/<?php echo ($vo["image"]); ?>" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11"><?php echo ($vo["product_name"]); ?></a>
														</div>
													</div>
												</li>
												<li class="td td-info">
												...
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now"><?php echo ($vo["price"]); ?></em>
														</div>
													</div>
												</li>
											</div>
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number"><?php echo ($vo['price']*$vo['quantity']); ?></em>
												</div>
											</li>
						...
						<!--留言-->
							...
							<div class="buy-point-discharge ">
								<p class="price g_price ">
									合计（含运费） <span>¥</span><em class="pay-sum pay_sum">244.00</em>
								</p>
							</div>
								...
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">244.00</em>
										...
										<div id="holyshit268" class="pay-address">
											<?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["default"] == '1'): ?><p class="buy-footer-address">
												<span class="buy-line-title buy-line-title-type">寄送至：</span>
												<span class="buy--address-detail">
								   				<span class="province"><?php echo ($vo["province"]); ?></span>
												<span class="city"><?php echo ($vo["city"]); ?></span>
												<span class="dist"><?php echo ($vo["dist"]); ?></span>
												<span class="street"><?php echo ($vo["street"]); ?></span>
												</span>
												</span>
											</p>
...
<script type="text/javascript">
	...
	$(document).ready(function() {							
		$(".user-addresslist").click(function() {
			...
			var add_id = $(this).find('.add_id').val();
			console.log('/thinkphp/Home/Cart/addressajax/add_id/'+add_id);
    		$.ajax({
				url:'/thinkphp/Home/Cart/addressajax/add_id/'+add_id,
					type:'get',
					dataType:'json',
...
var totalprice = '';
$(function(){
	number =parseInt($('.J_ItemSum').text())+',';
	console.log(number);
	...
	$('.am-btn').on('click',function(){
		...
		var J_Price = $(this).parents('ul').find('.J_Price');
		
		var price = parseInt(J_Price.text());
		var J_ItemSum = $(this).parents('ul').find('.J_ItemSum');
		J_ItemSum.text(price*nowQuantity);

		var pay_sum = $(this).parents('ul').find('.pay_sum');
		pay_sum.text(J_ItemSum.val());
	});
});
</script>