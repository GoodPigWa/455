...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="/thinkphp/Public/Home/css/hmstyle.css" rel="stylesheet" type="text/css" />
		<script src="/thinkphp/Public/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
		<script src="/thinkphp/Public/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
	</head>
			...
			<div class="banner">
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="/thinkphp/Public/Home/images/ad1.jpg" /></a></li>
								<li class="banner2"><a><img src="/thinkphp/Public/Home/images/ad2.jpg" /></a></li>
								<li class="banner3"><a><img src="/thinkphp/Public/Home/images/ad3.jpg" /></a></li>
								<li class="banner4"><a><img src="/thinkphp/Public/Home/images/ad4.jpg" /></a></li>
				...
				<ul class="category-list" id="js_climit_li">
					<li class="appliance js_toggle relative first">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
							<em>&gt;</em></div>
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/cookies.png"></i><a class="ml-22" title="饼干、膨化">饼干/膨化</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
					...
					<li class="appliance js_toggle relative last">
						<div class="category-info">
							<h3 class="category-name b-category-name"><i><img src="/thinkphp/Public/Home/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
							<em>&gt;</em></div>
						<div class="menu-item menu-in top">
							<div class="area-in">
								<div class="area-bg">
...
<script type="text/javascript">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a href="sort.html"><img src="/thinkphp/Public/Home/images/navsmall.jpg" />
								<div class="title">商品分类</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/thinkphp/Public/Home/images/huismall.jpg" />
								<div class="title">大聚惠</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/thinkphp/Public/Home/images/mansmall.jpg" />
								<div class="title">个人中心</div>
							</a>
						</div>
						<div class="am-u-sm-3">
							<a href="#"><img src="/thinkphp/Public/Home/images/moneysmall.jpg" />
					...
					<div class="marqueen">
						...
						<div class="demo">
							...
							<ul>
								<li class="title-first"><a target="_blank" href="#">
									<img src="/thinkphp/Public/Home/images/TJ2.jpg"></img>
									<span>[特惠]</span>商城爆品1分秒								
								</a></li>
								<li class="title-first"><a target="_blank" href="#">
									<span>[公告]</span>商城与广州市签署战略合作协议
								     <img src="/thinkphp/Public/Home/images/TJ.jpg"></img>
						...
						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="../person/index.html">
									<img src="/thinkphp/Public/Home/images/getAvatar.do.jpg">
								</a>
								<em>
                        ...
                        <div class="advTip"><img src="/thinkphp/Public/Home/images/advTip.jpg"/></div>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				...
				<!--今日推荐 -->
					<div class="am-g am-g-fixed recommendation">
						<div class="clock am-u-sm-3">
							<img src="/thinkphp/Public/Home/images/2016.png "></img>
							<p>今日<br>推荐</p>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<img src="/thinkphp/Public/Home/images/tj.png "></img>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain two">
								<img src="/thinkphp/Public/Home/images/tj1.png "></img>
							</div>
						</div>
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
							...
							<div class="recommendationMain three ">
								<img src="/thinkphp/Public/Home/images/tj2.png "></img>
							</div>
						</div>
					</div>
					<div class="clear "></div>
					  ...
					  <div class="am-g am-g-fixed ">
						<div class="am-u-sm-3 ">
							...
							<div class="activityMain ">
								<img src="/thinkphp/Public/Home/images/activity1.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>														
						...
						<div class="am-u-sm-3 ">
						  <div class="icon-sale two "></div>	
							<h4>特惠</h4>
							<div class="activityMain ">
								<img src="/thinkphp/Public/Home/images/activity2.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>								
							</div>							
						...
						<div class="am-u-sm-3 ">
							...
							<h4>团购</h4>
							<div class="activityMain ">
								<img src="/thinkphp/Public/Home/images/activity3.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>							
						...
						<div class="am-u-sm-3 last ">
							...
							<h4>超值</h4>
							<div class="activityMain ">
								<img src="/thinkphp/Public/Home/images/activity.jpg "></img>
							</div>
							<div class="info ">
								<h3>春节送礼优选</h3>
							</div>													
					...
					<div class="am-g am-g-fixed floodFive ">
						...
						<div class="am-u-sm-5 am-u-md-3 text-one list">
							...
							<a href="# ">
								<img src="/thinkphp/Public/Home/images/act1.png " />
								<div class="outer-con ">
									<div class="title ">
										零食大礼包开抢啦
									</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>									
								...
								<a href="# "><img src="/thinkphp/Public/Home/images/1.jpg " /></a>						
						</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="/thinkphp/Public/Home/images/2.jpg" /></a>
						</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="/thinkphp/Public/Home/images/5.jpg" /></a>
						</div>			
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="/thinkphp/Public/Home/images/3.jpg" /></a>
						</div>	
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
							...
							<a href="# "><img src="/thinkphp/Public/Home/images/4.jpg" /></a>
						</div>	
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>									
				...
				<a href="# "><img src="/thinkphp/Public/Home/images/6.jpg" /></a>
			</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>									
				...
				<a href="# "><img src="/thinkphp/Public/Home/images/7.jpg" /></a>
			</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
			...
			<a href="# "><img src="/thinkphp/Public/Home/images/10.jpg" /></a>
		</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
			...
			<a href="# "><img src="/thinkphp/Public/Home/images/9.jpg" /></a>
		</div>
...
<i class="am-icon-shopping-basket am-icon-md  seprate"></i>								
			...
			<a href="# "><img src="/thinkphp/Public/Home/images/8.jpg" /></a>
		</div>
			...
			<div id="sidebar">
				<div id="wrap">
					<div id="prof" class="item">
						...
						<div class="ibar_login_box status_login">
							<div class="avatar_box">
								<p class="avatar_imgbox"><img src="/thinkphp/Public/Home/images/no-img_mid_.jpg" /></p>
								<ul class="user_info">
									<li>用户名：sl1903</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
					...
					<div id="brand" class="item">
						<a href="#">
							<span class="wdsc"><img src="/thinkphp/Public/Home/images/wdsc.png" /></span>
						</a>
						<div class="mp_tooltip">
							我的收藏
							<i class="icon_arrow_right_black"></i>
					...
					<div id="broadcast" class="item">
						<a href="#">
							<span class="chongzhi"><img src="/thinkphp/Public/Home/images/chongzhi.png" /></span>
						</a>
						<div class="mp_tooltip">
							我要充值
							<i class="icon_arrow_right_black"></i>
					...
					<div class="quick_toggle">
						...
						<li class="qtitem">
							...
							<div class="mp_qrcode" style="display:none;"><img src="/thinkphp/Public/Home/images/weixin_code_145.png" /><i class="icon_arrow_white"></i></div>
						</li>
						<li class="qtitem">
