...
<html>
	<head lang="en">
		...
		<link rel="stylesheet" href="/thinkphp/Public/AmazeUI-2.4.2/assets/css/amazeui.css" /> 
	...
	<body>
		...
		<div class="login-boxtitle">
			<a href="home.html"><img alt="logo" src="/thinkphp/Public/Home/images/logobig.png" /></a>
		</div>
				...
				<div class="login-box">
						...
						<div class="login-form">
						  <form action="<?php echo U('User/login');?>" method="post">
						  	<input type="hidden" name="transUrl" value="<?php echo ($transUrl); ?>">
							   <div class="user-name">
