...
<html>
	...
	<head>
		...
		<link href="/thinkphp/Public/Home/css/colstyle.css" rel="stylesheet" type="text/css">
				...
				<div class="main-wrap">
					...
					<div class="user-collection">
						...
						<div class="you-like">
							...
							<div class="s-content">
								<?php if(is_array($coll)): $i = 0; $__LIST__ = $coll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="s-item-wrap">
									<div class="s-item">
										<div class="s-pic">
											<a href="#" class="s-pic-link">
												<img src="/thinkphp/Public/Home/<?php echo ($vo["image"]); ?>" alt="" title="" class="s-pic-img s-guess-item-img">
											</a>
										</div>
										<div class="s-info">
											<div class="s-title"><a href="#" title=""><?php echo ($vo["product_name"]); ?></a></div>
											<div class="s-price-box">
												<span class="s-price"><em class="s-price-sign">¥</em><em class="s-value"><?php echo ($vo["sales_price"]); ?></em></span>
												<span class="s-history-price"><em class="s-price-sign">¥</em><em class="s-value"><?php echo ($vo["price"]); ?></em></span>
											</div>
